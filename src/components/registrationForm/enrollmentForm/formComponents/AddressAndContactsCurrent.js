...
export default class AddressAndContactsCurrent extends Component {
    state = {
        cities: null, isProvinceSelected: false
    }
    componentDidMount = () => {
        const province = (this.props.values.provinceCurrentAddCode) ? this.props.values.provinceCurrentAddCode : "";
        this.getCities(province);
    }
    handleOnChangeInput = e => {
        if(e.target.name === "provinceCurrentAdd") {
            ...
            this.props.handleOnChangeInput("cityCurrentAdd", "");
            ...
            <Fragment>
                <div className="columns is-vcentered mt-0 pt-0">
                    ...
                    <div className="column">
                        <h3 className="has-text-weight-bold is-size-5 mb-0 pb-0">Current Address</h3>
                    </div>
                </div>
                <div className="columns is-vcentered">
                    ...
                    <div className="column is-2">                                             
                        ...
                        <div className="field">
                            <div className="control has-icons-left has-icons-right">                                                    
                                <input name="zipcodeCurrentAdd" className="input" type="text" placeholder="Zip Code" 
                                       onChange={this.handleOnChangeInput} value={values.zipcodeCurrentAdd} data-fieldname="Current Address Zip Code"/>
                    ...
                    <div className="column">                                                
                        ...
                        <div className="field">
                            <div className="control is-expanded">                           
                                <SelectProvince 
                                    name="provinceCurrentAdd"
                                    value={values.provinceCurrentAddCode}
                                    required={true}
                                    fieldname="Current Address Province"
                    ...
                    <div className="column"> 
                        ...
                        <div className="field">
                            <div className="control is-expanded">
                                <SelectCity
                                    name="cityCurrentAdd"
                                    province={values.provinceCurrentAddCode}
                                    cities={cities}
                                    value={values.cityCurrentAdd}
                                    required={true}
                                    fieldname="Current Address City / Municipality"
                                    handleOnChangeInput={this.handleOnChangeInput}  
                    ...
                    <div className="column"> 
                        ...
                        <div className="field">
                            <div className="control has-icons-left has-icons-right">                                                    
                                <input name="barangayCurrentAdd" className="input" type="text" placeholder="Barangay" 
                                       onChange={this.handleOnChangeInput} value={values.barangayCurrentAdd} data-fieldname="Current Barangay"/>
                                <span className="icon is-small is-left">
                ...
                <div className="columns is-vcentered">
                    ...
                    <div className="column"> 
                        ...
                        <div className="field">
                            <div className="control has-icons-left has-icons-right">                                                    
                                <input name="streetCurrentAdd" className="input" type="text" placeholder="House #, Street, Subdiv/Village, Sitio" 
                                       onChange={this.handleOnChangeInput} value={values.streetCurrentAdd} required data-fieldname="Current Address Street"/>
                                <span className="icon is-small is-left">
